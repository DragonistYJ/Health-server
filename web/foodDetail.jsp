...
<div id="wrapper-container">
    ...
    <div class="container object">
        ...
        <div id="main-container-image">
            ...
            <div class="title-item">
                ...
                <div class="title-text1">{{classification}} {{classification2}}</div>
            </div>
            ...
            <div class="work">
                ...
                <div class="wrapper-text-description">
                    ...
                    <div class="wrapper-file">
                        <div class="icon-file">功效</div>
                        <div class="text-file" v-html="effect">{{effect}}</div>
                    </div>

                    <div class="wrapper-weight">
                        <div class="icon-weight">营养价值</div>
                        <div class="text-weight" v-html="value">{{value}}</div>
                    </div>

                    <div class="wrapper-desc">
                        <div class="icon-desc">别名</div>
                        <div class="text-desc" v-html="alias">{{alias}}</div>
                    </div>

                    <div class="wrapper-morefrom">
                        <div class="text-morefrom">成分表</div>
                        <ul class="text-file">
                            <li>热量：{{nutrition[0]}}</li>
                            <li>蛋白质：{{nutrition[1]}}</li>
                            <li>脂肪：{{nutrition[2]}}</li>
                            <li>碳水化合物：{{nutrition[3]}}</li>
                            <li>纤维素：{{nutrition[4]}}</li>
                            <li>维生素A：{{nutrition[5]}}</li>
                            <li>维生素C：{{nutrition[6]}}</li>
                            <li>维生素E：{{nutrition[7]}}</li>
                            <li>胡萝卜素：{{nutrition[8]}}</li>
                            <li>硫胺素：{{nutrition[9]}}</li>
                            <li>核黄素：{{nutrition[10]}}</li>
                            <li>烟酸：{{nutrition[11]}}</li>
                            <li>胆固醇：{{nutrition[12]}}</li>
                            <li>镁：{{nutrition[13]}}</li>
                            <li>钙：{{nutrition[14]}}</li>
                            <li>铁：{{nutrition[15]}}</li>
                            <li>锌：{{nutrition[16]}}</li>
                            <li>铜：{{nutrition[17]}}</li>
                            <li>锰：{{nutrition[18]}}</li>
                            <li>钾：{{nutrition[19]}}</li>
                            <li>磷：{{nutrition[20]}}</li>
                            <li>钠：{{nutrition[21]}}</li>
                            <li>硒：{{nutrition[22]}}</li>
                        </ul>
                    </div>
    ...
    <script>
        var vm = new Vue({
            ...
            mounted: function () {
                $.ajax({
                    url: "/HEALTH/Detail/food?name=" + '<%=request.getParameter("name")%>',
                    type: "post",
                    async: true,
                    dataType: 'json',
                    processData: false,
                    ...
                    success: function (data, textStatus) {
                        vm.name = data.name;
                        vm.classification = data.classification;
                        vm.classification2 = data.classification2;
                        vm.description = data.description;
                        vm.effect = data.effect;
                        vm.value = data.value;
                        vm.alias = data.alias;
                        vm.image = "/HEALTH/images/food/food" + data.id + ".jpg";
                        vm.nutrition.push(data.n1);
                        vm.nutrition.push(data.n2);
                        vm.nutrition.push(data.n3);
                        vm.nutrition.push(data.n4);
                        vm.nutrition.push(data.n5);
                        vm.nutrition.push(data.n6);
                        vm.nutrition.push(data.n7);
                        vm.nutrition.push(data.n8);
                        vm.nutrition.push(data.n9);
                        vm.nutrition.push(data.n10);
                        vm.nutrition.push(data.n11);
                        vm.nutrition.push(data.n12);
                        vm.nutrition.push(data.n13);
                        vm.nutrition.push(data.n14);
                        vm.nutrition.push(data.n15);
                        vm.nutrition.push(data.n16);
                        vm.nutrition.push(data.n17);
                        vm.nutrition.push(data.n18);
                        vm.nutrition.push(data.n19);
                        vm.nutrition.push(data.n20);
                        vm.nutrition.push(data.n21);
                        vm.nutrition.push(data.n22);
                        vm.nutrition.push(data.n23);
                    },
